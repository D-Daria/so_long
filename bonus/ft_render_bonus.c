...
/*   Updated: 2022/04/13 13:45:52 by mrhyhorn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_draw_walls(int x, int y, t_data *data)
{
	if (x == 0 && y == 0)
...
static void	ft_draw_map(int x, int y, char ch, t_data *data)
{
	if (ch == '0')
	...
	else if (ch == 'P')
	{
		...
		ft_put_img(VILLAIN_1, x, y, data);
}

static void	ft_draw_background(char *img, t_data *data)
{
	int	w;
	int	h;
